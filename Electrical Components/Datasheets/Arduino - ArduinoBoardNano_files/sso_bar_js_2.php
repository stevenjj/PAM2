...
function ssoGenerateLoginBar() {
  $r = '<div class="lo"><a href="http://id.arduino.cc//auth/login/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FMain%2FarduinoBoardNano">Sign in</a> or ';
  $r += '<a href="http://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FMain%2FarduinoBoardNano">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
